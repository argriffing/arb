...
.. function:: void _acb_hypgeom_gamma_lower_series(acb_ptr res, acb_t s, acb_srcptr z, slong zlen, slong n, slong prec)

.. function:: void acb_hypgeom_gamma_lower_series(acb_poly_t res, const acb_t s, const acb_poly_t z, slong n, slong prec)

    Sets *res* to the lower incomplete gamma function `\gamma(s,z)` where *s* is
    a constant and *z* is a power series, truncated to length *n*.
